class DeadZone_LocalMessage extends Object;

enum E_DeadZone_LocalMessageType
{
	DeadZone_PlayerGiveBoostToServer,
	DeadZone_PlayerGiveBoostToServerFirst,
	DeadZone_PlayerGiveBoostToServerMax,
	DeadZone_BoosterLeaveServer,
	DeadZone_BoosterLeaveServerMax,
	DeadZone_BoosterLeaveServerNoBoost,
	
	DeadZone_AllowedLevels,
...
public static function String GetLocalizedString(
	E_LogLevel LogLevel,
	E_DeadZone_LocalMessageType LMT,
	...
	optional String String3)
{
	...
	switch (LMT)
	{
		case DeadZone_PlayerGiveBoostToServer:
		...
		case DeadZone_PlayerGiveBoostToServerFirst:
		...
		case DeadZone_PlayerGiveBoostToServerMax:
			RV = (default.PlayerGivesBoost != "" ? default.PlayerGivesBoost : default.PlayerGivesBoostDefault)
			   @ (default.TotalBoost != "" ? default.TotalBoost : default.TotalBoostDefault)
		...
		case DeadZone_BoosterLeaveServer:
		...
		case DeadZone_BoosterLeaveServerMax:
			RV = (default.PlayerLeft != "" ? default.PlayerLeft : default.PlayerLeftDefault)
			   @ (default.TotalBoost != "" ? default.TotalBoost : default.TotalBoostDefault)
			   @ (default.Max != "" ? default.Max : default.MaxDefault);
			RV = ReplPlayer(RV, String1);
		...
		case DeadZone_BoosterLeaveServerNoBoost:
			RV = (default.PlayerLeft != "" ? default.PlayerLeft : default.PlayerLeftDefault)
			   @ (default.NoBoost != "" ? default.NoBoost : default.NoBoostDefault);
			RV = ReplPlayer(RV, String1);
			break;
			
		case DeadZone_AllowedLevels:
